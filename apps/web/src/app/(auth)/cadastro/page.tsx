    ...
    return (
      <div className="w-full max-w-sm">
        <div className="bg-white rounded-2xl shadow-sm border border-flor-100 p-8 text-center">
          ...
          <h2 className="text-lg font-medium text-flor-800 mb-2">Quase lá!</h2>
          <p className="text-sm text-flor-500 mb-6">
            Enviamos um e-mail de confirmação. Verifique sua caixa de entrada e clique no link para
            ativar sua conta.
          </p>
          <Link
  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm text-flor-500">Crie sua conta</p>
      </div>

      <div className="bg-white rounded-2xl shadow-sm border border-flor-100 p-8">
        <h2 className="text-lg font-medium text-flor-800 mb-6">Cadastro</h2>

        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-flor-700 mb-1.5">
              Nome
            </label>
            <input
              id="name"
